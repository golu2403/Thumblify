...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="why use our generator" text3="Create stunning thumbnail that get clicks, without the hassel." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI thumbnail generator is designed to help you create stunning thumbnails that get clicks, without the hassle. With our prebuilt components and modern Figma-driven UI, you can launch production-ready pages in minutes. Tailwind utility-first classes make customization trivial, allowing you to create a thumbnail that perfectly fits your brand and style.
                </motion.p>
