        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Generate yout first thumbnail for free </span>
            ...
            >
                <button onClick={()=>navigate("/generates")} className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11">
                    Generates now
                </button>
