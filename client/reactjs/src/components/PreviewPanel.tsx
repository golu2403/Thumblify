        ...
        {isLoading && (
          <div className='absolute inset-0 flex flex-col items-center justify-center bg-slate-900/50 backdrop-blur-sm'>
            ...
            <div className=' text-center'>
              <p className='text-sm text-zinc-400'>AI is creating your thumbnail...</p>
          ...
          <div className="group relative h-full w-full">
            <img src={thumbnail?.image_url} alt={thumbnail.title}
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
                <button onClick={onDownload} type='button' className="mb-6 flex items-center gap-2 rounded-md px-5 py-2.5 text-xs font-medium transition bg-white/30 ring-2 ring-white/40 backdrop-blur-sm hover:bg-white/40 hover:ring-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
